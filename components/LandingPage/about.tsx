...
export default function About() {
  return (
    <section className='flex flex-col lg:flex-row py-[4rem] justify-between  h-full font-poppins place-content-center'>
      ...
      <div className='flex flex-col w-full order-1'>
        ...
        <p className='text-[#1E1E1E8C] w-full max-w-[56rem] text-sm text-center lg:text-left dark:text-[#FFFFFFCC] mb-4'>
